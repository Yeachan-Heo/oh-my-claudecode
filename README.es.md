...
> **Nota:** `session-end` está definido en los tipos pero actualmente no es despachado por bridge.ts ([#1456](https://github.com/ohprettyhak/oh-my-claudecode/issues/1456)).
