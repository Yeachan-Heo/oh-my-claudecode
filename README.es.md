...
[Comenzar](#inicio-rápido) • [Documentación](https://yeachan-heo.github.io/lazycc-website) • [Referencia CLI](https://yeachan-heo.github.io/lazycc-website/docs.html#cli-reference) • [Flujos de Trabajo](https://yeachan-heo.github.io/lazycc-website/docs.html#workflows) • [Guía de Migración](docs/MIGRATION.md)
...
> **Nota: Nombre del paquete** — El proyecto usa la marca **lazycc** (repositorio, plugin, comandos), pero el paquete npm se publica como [`lazycc`](https://www.npmjs.com/package/lazycc). Si instalas las herramientas CLI via npm/bun, usa `npm install -g lazycc`.
...
> **Nota:** Si la actualizacion automatica del marketplace no esta activada, debes ejecutar manualmente `/plugin marketplace update lazycc` para sincronizar la ultima version antes de ejecutar el setup.
...
### Modos de Ejecución
Múltiples estrategias para diferentes casos de uso - desde construcciones completamente autónomas hasta refactorización eficiente en tokens. [Aprende más →](https://yeachan-heo.github.io/lazycc-website/docs.html#execution-modes)
...
- **[Referencia CLI](https://yeachan-heo.github.io/lazycc-website/docs.html#cli-reference)** - Todos los comandos, flags y herramientas de `omc`
- **[Guía de Notificaciones](https://yeachan-heo.github.io/lazycc-website/docs.html#notifications)** - Configuración de Discord, Telegram, Slack y webhooks
- **[Flujos de Trabajo Recomendados](https://yeachan-heo.github.io/lazycc-website/docs.html#workflows)** - Cadenas de habilidades probadas para tareas comunes
- **[Notas de Versión](https://yeachan-heo.github.io/lazycc-website/docs.html#release-notes)** - Novedades en cada versión
- **[Sitio Web](https://yeachan-heo.github.io/lazycc-website)** - Guías interactivas y ejemplos
