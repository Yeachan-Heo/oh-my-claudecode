...
Skills are reusable workflow templates that can be invoked via `/lazycc:skill-name`. Each skill provides:
...
- Test skill invocation with `/lazycc:skill-name`
