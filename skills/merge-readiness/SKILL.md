...
description: "Post-task merge readiness gate with explanation artifact and human explainability quiz"
...
- You need a durable artifact showing why the team can trust and understand the change before asking for merge approval
</Use_When>
...
```json
{
  ...
  "readiness_score": 0,
  "result": "pending",
  "artifact_path": ".omc/artifacts/merge-readiness/<timestamp>-<slug>.md"
}
```
...
The artifact renders the five sections, evidence, quiz progress, readiness, and merge boundary. Correct answers and rationales remain hidden until the attempt is complete; cancellation or override reveals only answered questions.
...
- User says stop/cancel/abort -> persist current artifact and stop.
