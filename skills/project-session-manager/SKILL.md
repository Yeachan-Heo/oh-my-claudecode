...
1. Use the **Write tool** to save the script content to a temporary file in the current directory (e.g., `./omc-psm.sh`)
2. Use the **Bash tool** to execute: `bash ./omc-psm.sh`
3. Clean up: `rm -f ./omc-psm.sh`
