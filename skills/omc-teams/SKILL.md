...
| `Unsupported agent type`     | Requested agent is not claude/codex/gemini/grok/cursor/gjc | Use `claude`, `codex`, `gemini`, `grok`, `cursor`, or `gjc`; for native Claude Code agents use `/oh-my-claudecode:team` |
