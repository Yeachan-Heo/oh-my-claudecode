...
# → Scegli "Custom Integration" → "OpenClaw Gateway"
```
...
> **Nota:** `session-end` è definito nei tipi ma non è attualmente inviato da bridge.ts ([#1456](https://github.com/Yeachan-Heo/oh-my-claudecode/issues/1456)).
