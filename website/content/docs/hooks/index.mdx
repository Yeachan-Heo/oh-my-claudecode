...
oh-my-claudecode는 31개의 훅으로 Claude Code의 기본 동작을 확장합니다.
...
- [라이프사이클 이벤트](/docs/hooks/lifecycle-events) -- 10개 이벤트와 훅 매핑
- [핵심 훅](/docs/hooks/core-hooks) -- 실행 모드와 오케스트레이션 훅
- [컨텍스트 관리 훅](/docs/hooks/context-hooks) -- 메모리와 컴팩션 훅
- [매직 키워드](/docs/hooks/magic-keywords) -- 자연어로 모드를 활성화하는 시스템
