 ...
 */
export declare const OMC_PLUGIN_MARKETPLACE_SLUG = "lazycc";
export declare const OMC_PLUGIN_PACKAGE_NAME = "lazycc";
export declare const OMC_PLUGIN_CACHE_REL = "plugins/cache/lazycc/lazycc";
export declare const OMC_PLUGIN_MARKETPLACE_REL = "plugins/marketplaces/lazycc";
