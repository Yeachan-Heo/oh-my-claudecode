...
export interface HeartbeatData {
    workerName: string;
    teamName: string;
    provider: 'codex' | 'gemini' | 'claude' | 'cursor' | 'grok' | 'gjc';
    pid: number;
    lastPollAt: string;
...
/** Worker backend type */
export type WorkerBackend = 'claude-native' | 'mcp-codex' | 'mcp-gemini' | 'tmux-claude' | 'tmux-codex' | 'tmux-gemini' | 'tmux-cursor' | 'tmux-grok' | 'tmux-gjc';
...
export interface WorkerInfo {
    ...
    index: number;
    role: string;
    worker_cli?: 'codex' | 'claude' | 'gemini' | 'cursor' | 'grok' | 'gjc';
