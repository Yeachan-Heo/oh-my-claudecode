...
// /team CLI workers — codex/gemini/grok/cursor/gjc here are CLI integrations, NOT the deprecated MCP delegationRouting providers.
const TEAM_ROLE_PROVIDERS = new Set(["claude", "codex", "gemini", "grok", "cursor", "gjc"]);
                ...
                properties: {
                    ops: {
                        ...
                        properties: {
                            ...
                            defaultAgentType: {
                                type: "string",
                                enum: ["claude", "codex", "gemini", "grok", "cursor", "gjc"],
                                default: "claude",
                            },
                    ...
                    roleRouting: {
                        ...
                        additionalProperties: {
                            type: "object",
                            properties: {
                                provider: { type: "string", enum: ["claude", "codex", "gemini", "grok", "cursor", "gjc"] },
                                model: { type: "string" },
                                agent: { type: "string" },
                            },
                        },
