...
[Bắt đầu nhanh](#bắt-đầu-nhanh) • [Tài liệu](https://yeachan-heo.github.io/lazycc-website) • [Tham chiếu CLI](https://yeachan-heo.github.io/lazycc-website/docs.html#cli-reference) • [Quy trình](https://yeachan-heo.github.io/lazycc-website/docs.html#workflows) • [Hướng dẫn di chuyển](docs/MIGRATION.md)
...
> **Lưu ý: Tên package** — Dự án được xây dựng thương hiệu là **lazycc** (repo, plugin, commands), nhưng package npm được phát hành dưới tên [`lazycc`](https://www.npmjs.com/package/lazycc). Nếu bạn cài công cụ CLI qua npm/bun, hãy dùng `npm install -g lazycc`.
...
> **Lưu ý:** Nếu tự động cập nhật marketplace chưa được bật, bạn cần chạy `/plugin marketplace update lazycc` thủ công để đồng bộ phiên bản mới nhất trước khi chạy setup.
...
Nhiều chiến lược cho nhiều tình huống — từ điều phối dựa trên Team đến refactor tiết kiệm token. [Tìm hiểu thêm →](https://yeachan-heo.github.io/lazycc-website/docs.html#execution-modes)
...
- **[Tham chiếu CLI](https://yeachan-heo.github.io/lazycc-website/docs.html#cli-reference)** - Tất cả lệnh, cờ và công cụ `omc`
- **[Hướng dẫn thông báo](https://yeachan-heo.github.io/lazycc-website/docs.html#notifications)** - Thiết lập Discord, Telegram, Slack và webhook
- **[Quy trình khuyến nghị](https://yeachan-heo.github.io/lazycc-website/docs.html#workflows)** - Chuỗi skill đã qua thực chiến cho các tác vụ phổ biến
- **[Ghi chú phát hành](https://yeachan-heo.github.io/lazycc-website/docs.html#release-notes)** - Có gì mới trong mỗi phiên bản
- **[Website](https://yeachan-heo.github.io/lazycc-website)** - Hướng dẫn tương tác và ví dụ
