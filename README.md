...
_Like Sisyphus, these agents persist until every task is complete._
...
> **Day 0:** oh-my-opencode was born. A multi-agent orchestration system. Beautiful. Powerful. Perhaps _too_ powerful.
>
...
_Port of [oh-my-opencode](https://github.com/code-yeongyu/oh-my-opencode)._
...
```bash
bun add -g oh-my-claude-sisyphus
```
...
> **Windows Users**: npm is the recommended installation method. Requires Node.js 18+.
...
```bash
bun add oh-my-claude-sisyphus @anthropic-ai/claude-agent-sdk
```
...
- **Recommended**: Bun 1.0+ (`bun add -g oh-my-claude-sisyphus`)
- **Windows**: Node.js 18+ (for npm installation)
- **macOS/Linux**: Bash shell (default) or Bun/Node.js
...
| **macOS**   | curl, bun, or npm | Bash (.sh)     |
| **Linux**   | curl, bun, or npm | Bash (.sh)     |
...
_One must imagine a multi-agent system happy._
