...
# → "Custom Integration" を選択 → "OpenClaw Gateway" を選択
```
...
> **注意:** `session-end` はタイプに定義されていますが、現在 bridge.ts ではディスパッチされていません（[#1456](https://github.com/Yeachan-Heo/oh-my-claudecode/issues/1456)）。
