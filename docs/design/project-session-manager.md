...
```bash
# Review PR #123 from lazycc repo
/psm review omc#123
...
// .psm-session.json
{
  ...
  "source_repo": "~/Workspace/lazycc",
  "github": {
    "pr_number": 123,
    "pr_title": "Add webhook support",
    "pr_author": "contributor",
    "pr_url": "https://github.com/anthropics/lazycc/pull/123"
  },
  "state": "active",
  "notes": []
}
