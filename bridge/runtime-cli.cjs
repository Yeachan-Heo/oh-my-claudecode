...
var import_child_process4, import_util5, fsPromises, execFileAsync;
var init_process_utils = __esm({
  "src/platform/process-utils.ts"() {
    ...
    execFileAsync = (0, import_util5.promisify)(import_child_process4.execFile);
  }
});
...
var RoleInputSchema = external_exports.string().trim().min(1);
var LAZYCODEX_CLAUDE_ROLE_ROUTES = [
  {
    role: "explorer",
...
var LazyCodexAgentRouteConfigError = class extends Error {
  role;
  constructor(role) {
...
var LAZYCODEX_READ_ONLY_TOOLS = ["Read", "Glob", "Grep"];
var LAZYCODEX_REVIEW_TOOLS = ["Read", "Glob", "Grep", "Bash"];
var LAZYCODEX_PLAN_TOOLS = ["Read", "Glob", "Grep", "Bash", "Write", "TodoWrite"];
var LAZYCODEX_SOURCE_WRITE_TOOLS = ["Read", "Glob", "Grep", "Edit", "Write", "Bash", "TodoWrite"];
var LAZYCODEX_QA_TOOLS = ["Bash", "Read", "Grep", "Glob", "TodoWrite"];
var lazycodexExplorerAgent = {
  name: "explorer",
...
var lazycodexCodeReviewerAgent = {
...
var lazycodexGateReviewerAgent = {
...
var DEFAULT_FACTCHECK_POLICY = {
  ...
  forbidden_path_prefixes: ["${CLAUDE_CONFIG_DIR}/plugins/cache/lazycc/"],
