...
export interface TranscriptData {
  ...
  /** Session-accumulated input tokens (for cost estimation) */
  sessionInputTokens?: number;
  /** Session-accumulated output tokens (for cost estimation) */
...
export interface HudElementConfig {
  ...
  showCost?: boolean;            // Show estimated cost for last request ($0.02) and session (sess:$1.23)
