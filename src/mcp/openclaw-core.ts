...
let openclawCliPath: string | null = null;
let detectionAttempted = false;

/**
 * Detect if OpenClaw CLI is installed and available
 */
export function detectOpenclawCli(): string | null {
 ...
 */
export async function sendToSession(sessionKey: string, message: string): Promise<{
  success: boolean;
  result?: string;
  error?: string;
}> {
