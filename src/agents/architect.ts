...
export const architectAgent: AgentConfig = {
  ...
  tools: ['Read', 'Grep', 'Glob', 'Bash', 'WebSearch', 'lsp_diagnostics', 'lsp_diagnostics_directory', 'ast_grep_search', 'clawdcoder_session_list', 'clawdcoder_session_output', 'clawdcoder_status'],
  model: 'opus',
  defaultModel: 'opus',
