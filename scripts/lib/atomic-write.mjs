...
/**
 * Validates a parsed object as a lease-based lock owner using the SAME checks
 ...
 * identity and is NOT probed for liveness. Single owner validator (B4: folded
 * the two divergent validators into one).
 */
